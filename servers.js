...
const USER_SERVICE_SERVER = "http://localhost";
const POST_SERVICE_SERVER = "http://localhost";
const NOTIFICATION_SERVICE_SERVER = "http://localhost";

const USER_SERVICE_MYSQL_SERVER = "localhost";
const POST_SERVICE_MYSQL_SERVER = "localhost";
const NOTIFICATION_SERVICE_MYSQL_SERVER = "localhost";

const MYSQL_SERVER_USER = "abhidb";
const MYSQL_SERVER_PASSWORD = "admin";
const DATABASE_NAME = "DeSo";

const MINIO_SERVER = "localhost";
